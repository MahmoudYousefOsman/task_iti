...
Route::get('/tarcks', [TrackController::class, 'index'])->name('tracks.index');
...
Route::get('/track/{id}/edit', [TrackController::class, 'edit'])->name('tracks.edit');
Route::put('/track/{id}', [TrackController::class, 'update'])->name('tracks.update');
